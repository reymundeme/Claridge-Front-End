...
export default function TextSection({ title, content, background }: TextSectionProps) {
  ...
  return (
    <section className="min-h-[500px] relative py-24 text-gray-800 bg-gradient-to-b from-white/50 to-stone-200/50">
      {/* Background */}
      {background?.url ? (
        <Image
          src={background.url}
        ...
        <video
          ...
          playsInline
          poster={testPoster}
          className="absolute inset-0 w-full h-full object-cover brightness-50 opacity-30"
        >
      ...
      {/* Content */}
  <div className="relative z-10 max-w-6xl mx-auto px-6 text-justify text-stone-800">
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-12">{title}</h2>
